...
- Server 改动以当前目录源码、`config/`、`deploy_config.sh` 和当前目录 README 说明为真实入口；接口、错误语义与观测字段变更优先同步回写到工作区根目录 `harness/docs/api/<repo>/server/` 与 `harness/docs/design/<repo>/server/`。
