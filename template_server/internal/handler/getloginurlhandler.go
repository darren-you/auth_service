...
func GetLoginURLHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetLoginURLReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewGetLoginURLLogic(r.Context(), svcCtx)
		resp, err := l.GetLoginURL(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
