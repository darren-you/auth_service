...
func IssueGuestDeviceIDHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GuestDeviceIDReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewIssueGuestDeviceIDLogic(r.Context(), svcCtx)
		resp, err := l.IssueGuestDeviceID(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
